...
export default function TaxesForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-gradient-to-r from-emerald-600 to-emerald-700 text-white p-6 rounded-t-lg shadow-lg">
        <h1 className="text-2xl font-bold flex items-center gap-3">
          <span className="text-3xl">💰</span>
          Taxe
        </h1>
        <p className="text-emerald-100 text-sm mt-2">Enregistrez les taxes des véhicules</p>
      </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <FormSection title="Informations générales" icon="📋" color="green">
            <div>
              ...
              <input value={number} onChange={e => setNumber(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="TAX-2026-001" />
            </div>
          </FormSection>

          <FormSection title="Montant" icon="💵" color="purple">
            <div>
              <label className="block text-sm font-medium text-gray-700 mb-2">Montant (DH)</label>
              <input value={amount} onChange={e => setAmount(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg text-right focus:ring-2 focus:ring-purple-500 focus:border-transparent" />
            </div>
          </FormSection>
