...
export default function CartesGrisesForm() {
  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      <div className="bg-gradient-to-r from-gray-700 to-gray-800 text-white p-6 rounded-t-lg shadow-lg">
        <h1 className="text-2xl font-bold flex items-center gap-3">
          <span className="text-3xl">🚙</span>
          Cartes grises
        </h1>
        <p className="text-gray-200 text-sm mt-2">Gérez les cartes grises des véhicules</p>
      </div>
        ...
        <div className="p-6 space-y-6">
          ...
          <FormSection title="Informations générales" icon="📋" color="green">
            <div>
              ...
              <input value={number} onChange={e => setNumber(e.target.value)} className="w-full px-3 py-2 border border-gray-300 rounded-lg focus:ring-2 focus:ring-green-500 focus:border-transparent" placeholder="CG-2026-001" />
            </div>
          </FormSection>
          ...
          <FormSection title="Documents & Commentaires" icon="📎" color="orange">
            <div className="space-y-4">
              <div>
                ...
                <input type="file" onChange={e => setFile(e.target.files ? e.target.files[0] : null)} className="w-full text-sm text-slate-500 file:mr-4 file:py-2 file:px-4 file:rounded-full file:border-0 file:text-sm file:font-semibold file:bg-orange-50 file:text-orange-700 hover:file:bg-orange-100" />
              </div>
              <div>
