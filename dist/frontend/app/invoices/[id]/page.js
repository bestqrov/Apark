...
const PdfDownloadButton_1 = require("../../../components/PdfDownloadButton");
function InvoiceDetail() {
    ...
    async function remove() {
        if (!confirm('Supprimer cette facture ?'))
            return;
        try {
            await axios_1.default.delete(`/invoices/${id}`);
    ...
    return (<div className="max-w-3xl mx-auto space-y-4">
      <div className="flex items-center justify-between">
        ...
        <div className="space-x-2">
          ...
          <a className="text-sm text-blue-600" href={void 0}><PdfDownloadButton_1.default id={id} type="invoice"/></a>
        </div>
      </div>
